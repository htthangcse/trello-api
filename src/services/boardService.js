...
const getDetails = async (boardId) => {
  try {
    ...
    // tùy mục đích về sau mà có cần clone deep hay không (video 63 sẽ giải thích)
    ...
    resBoard.columns.forEach(column => {
      ...
      // Cách khác đơn giản là covert ObjectId về string bằng hàm toString() của Javascript
